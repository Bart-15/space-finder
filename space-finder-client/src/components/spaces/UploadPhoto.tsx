...
const UploadPhoto = ({
  ...
  const labelStyles = `flex h-32 w-full flex-col border-4 border-dashed ${isError.photo?.message ? 'border-red-400 hover:border-red-500' : 'border-blue-200 hover:border-gray-300'} hover:bg-gray-100`;
